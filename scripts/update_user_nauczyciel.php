...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($updateUserSql) === TRUE) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Aktualizacja oceny kartkówki, jeśli różni się od dotychczasowej lub jest pusta i data modyfikacji nie jest null
            ...
            // Aktualizacja oceny sprawdzianu, jeśli różni się od dotychczasowej lub jest pusta i data modyfikacji nie jest null
            ...
            // Aktualizacja oceny odpowiedzi, jeśli różni się od dotychczasowej lub jest pusta i data modyfikacji nie jest null
